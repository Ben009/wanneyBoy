...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['manifest', 'vendor', 'certificate'],
      inject: true,
      minify: {
        removeComments: true,
        collapseWhitespace: true,
    ...
    new HtmlWebpackPlugin({
      filename: process.env.NODE_ENV === 'testing'
        ...
        : 'framework.html',
      template: 'index.html',
      chunks: ['manifest', 'vendor', 'framework'],
      inject: true,
      minify: {
        removeComments: true,
        collapseWhitespace: true,
    ...
    new HtmlWebpackPlugin({
      filename: process.env.NODE_ENV === 'testing'
        ...
        : 'resource.html',
      template: 'index.html',
      chunks: ['manifest', 'vendor', 'resource'],
      inject: true,
      minify: {
        removeComments: true,
        collapseWhitespace: true,
    ...
    new HtmlWebpackPlugin({
      filename: process.env.NODE_ENV === 'testing'
        ...
        : 'setting.html',
      template: 'index.html',
      chunks: [ 'manifest', 'vendor', 'setting'],
      inject: true,
      minify: {
        removeComments: true,
        collapseWhitespace: true,
