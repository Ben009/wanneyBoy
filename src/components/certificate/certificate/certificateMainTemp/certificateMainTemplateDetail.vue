<template>
     <section slot="footer" class="certificateMainClass" ref="certificateMainClass">
        <el-form ref="form" :model="form" :rules="rules" label-width="100px" >
          ...
          <el-col class="njmindSmallToMid main-mini" :span="6" v-if="form.zmbType == 1 ">
            <el-form-item label="证书类型" prop="zsType">
              <el-select v-model="form.zsType"  style="width:100%;">
                 <el-option
                  v-for="item in templateZsTypes"
                  :label="item.remark"
                  :value="item.remark">
                </el-option>
              </el-select>
          ...
          <el-col class="njmindSmallToMid main-mini" :span="6">
            <el-form-item label="检定类型" prop="jdType">
              <el-select v-model="form.jdType"  style="width:100%;">
                <el-option
          ...
          <el-col class="njmindSmallToMid main-mini" :span="6">
            <el-form-item label="是否省中心" prop="szxxmFlag">
              <el-select v-model="form.szxxmFlag"  style="width:100%;">
          ...
          <el-col class="njmindSmallToMid main-mini" :span="6">
            <el-form-item label="是否CNAS" prop="cnasFlag">
              <el-select v-model="form.cnasFlag"  style="width:100%;" >
                <el-option label="否" :value="0"></el-option>
                <el-option label="是" :value="1"></el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col class="njmindSmallToMid main-mini" :span="6">
            <el-form-item label="语言类型" prop="languageType">
              <el-select v-model="form.languageType"  style="width:100%;">
                <el-option label="中文" :value="1"></el-option>
                <el-option label="英文" :value="2"></el-option>
                <el-option label="中英文对照" :value="3"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col class="njmindSmallToMid main-mini" :span="6">
          <el-form-item label="规程数量" prop="jsgcCount" v-if="form.zmbType == 1 ">
            <el-input v-model="form.jsgcCount"></el-input>
          </el-form-item>
          </el-col>
          <el-col class="njmindSmallToMid main-mini" :span="6">
          <el-form-item label="标准数量" prop="jlbzCount" v-if="form.zmbType == 1 ">
            <el-input v-model="form.jlbzCount"></el-input>
          </el-form-item>
          </el-col>
          <el-col class="njmindSmallToMid main-mini" :span="6">
          <el-form-item label="标准器数量" prop="jlbzqCount" v-if="form.zmbType == 1 ">
            <el-input v-model="form.jlbzqCount"></el-input>
          </el-form-item>
          </el-col>
          <el-col class="njmindSmallToMid main-mini" :span="6">
          ...
          <el-form-item label="启用日期" prop="enableDate">
             <el-date-picker :picker-options="pickerOptions" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择日期" v-model="form.enableDate" style="width: 100%;"></el-date-picker>
          </el-form-item>
          </el-col>
          <el-col class="njmindSmallToMid main-mini" :span="6">
          <el-form-item label="停用日期"  prop="disableDate">
            <el-date-picker :picker-options="pickerOptions" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择日期" v-model="form.disableDate" style="width: 100%;"></el-date-picker>
          </el-form-item>
          </el-col>
...
//    },
    ...
    mounted() {
      ...
      this.loadJS(this.getCertificateTemplateDetail);
//      this.$refs.btn.onclick=this.toTest1.bind(this);
    ...
    methods: {
      calcEditorHeight(){
        ...
        this.kindEditor.height = mainHeight - (formHeight + 2)
...
//        }
      ...
      handleSubmit() {
        this.$refs.form.validate((valid) => {
          ...
          if (valid) {
            ...
            ajaxRequest('post',"back/certificateMainTemp/updateCertificate",this.form,(res) =>{
              if(res.code == 200){
      ...
      getCertificateTemplateDetail(){
        return new Promise(resolve => {
          if(this.zmbId != ""){
            ajaxRequest('get', 'back/certificateMainTemp/'+this.zmbId, null , (res) => {
              if (res.code === 200) {
                this.form = res.daoResult;
                this.kindEditor.html(this.form.zmbContent);
                this.setCertificateMainTemplateId();
                resolve()
              }
            });
          }
