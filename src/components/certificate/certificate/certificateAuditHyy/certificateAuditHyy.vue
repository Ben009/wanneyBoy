<template>
  <div class="certArea" ref="certArea-page" :style="{height:innerHeight+'px'}">
          ...
          <el-form :inline="true">
            ...
            <el-col :span="6" style="text-align: center;margin-top:10px;">
              <template>
                ...
                <el-tooltip content="当前需要核验的证书数量" placement="top">
      ...
      <div class="certRightArea" :style="{'width':calcWidth+'px','padding':'0px 5px','z-index':'1'}">
        <CertificateAuditHyyDetailMain
                                  ref="certificateAuditHyyDetailMain"
...
//  } from "element-ui";
  ...
  import CertificateAuditHyyDetailMain from './certificateAuditHyyDetailMain.vue';
...
//        searchDialogShow: false,
    ...
    components: {
      ElCol,CertificatesList,CertificateAuditHyyDetailMain,
...
//            if(this.$refs.certificateAuditHyyDetailMain) {
//              var showId = this.$refs.certificateAuditHyyDetailMain.$refs.certificateAddDetail.getCertificateId();
