          ...
          if (valid) {
            ...
            if(!_this.form.mlId){
              ...
              if(_this.form.isParent=='1'){
                ...
                ajaxRequest('post',"back/originalLogTemp/addOriginalLogTempMl",_this.form,function(res){
                  if(res.code == 200){
              ...
              //模板
                ...
                ajaxRequest('post',"back/originalLogTemp/addOriginalLogTemp",subForm,function(res){
                  if(res.code == 200){
              ...
              if(_this.form.isParent=='1'){
                ...
                ajaxRequest('put',"back/originalLogTemp/updateOriginalLogTempMl",_this.form,function(res){
                  if(res.code == 200){
              ...
              //模板
                ...
                ajaxRequest('put',"back/originalLogTemp/updateOriginalLogTemp4Info",subForm,function(res){
                  if(res.code == 200){
