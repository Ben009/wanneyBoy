        ...
        if(_this.certificateCanEdit) {
          ...
          if($(that).attr("name").startsWith("zs_jsgc_") || $(that).attr("name").startsWith("zs_jlbz_") || $(that).attr("name").startsWith("zs_jlbzq_")) {
              ...
              if ($(that).attr("name").startsWith("zs_jlbzq_")) {
                if (($(that).attr("name") == "zs_jlbzq_zsbh" || $(that).attr("name") == "zs_jlbzq_yxrq" ) ) {
...
//                return;
//              }
//            }else if($(this).attr("name").indexOf("zs_jlbzq") == 0){
//              if(!_this.canModifyCertificateGcInfo ){
//                return;
//              }
//              //id为空  zs_jlbzq_id
...
//                return;
//              }
//            }else if($(this).attr("name").indexOf("zs_jlbz") == 0){
//              if(!_this.canModifyCertificateGcInfo ){
//                return;
//              }
//              //id为空  zs_jlbz_id
...
//          if (jlbzRowArr.eq(i).find("[name='zs_jsgc_id']").eq(0).val() != "") {
//            //先寻找中文名称
...
//          if (bzqRowArr.eq(i).find("[name='zs_jsgc_id']").eq(0).val() != "") {
//            //先寻找中文名称
