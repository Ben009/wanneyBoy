<template>
  <div class="certArea" ref="certArea-page">
          ...
          <el-form :inline="true">
            ...
            <el-col :span="6" style="margin-top:14px;">
              <template>
                ...
                <el-tooltip content="当前需要核验的记录数量" placement="top">
      ...
      <div class="certRightArea" :style="{'width':calcWidth+'px','padding':'0px 5px','z-index':'1'}">
        <OriginalLogAuditHyyDetailMain
                                  ref="originalLogAuditHyyDetailMain"
...
<script>
  ...
  import OriginalLogAuditHyyDetailMain from './originalLogAuditHyyDetailMain.vue';
...
//        searchDialogShow: false,
    ...
    components: {
      ElCol,OriginalLogList,OriginalLogAuditHyyDetailMain,
...
//            if(this.$refs.originalLogAuditHyyDetailMain) {
//              var showId = this.$refs.originalLogAuditHyyDetailMain.$refs.certificateAddDetail.getCertificateId();
