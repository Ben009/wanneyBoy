    ...
    @close="handleCancel">
          <el-form ref="form" :model="form" :rules="rules" label-width="100px" >
            <el-col :span="24">
              ...
              <el-button type="primary" v-mindPopover="{message:'是否删除?',success:handleDel.bind()}" :disabled="form.zshtmlId == null " size="small" >删除</el-button>
              <!--{{form.zmbName}}-->
            </el-col>
             <el-col class="njmindSmallToMid main-mini" :span="24">
            ...
            <el-col class="njmindSmallToMid main-mini el-form-item  is-required" :span="6">
            ...
            <el-col class="njmindSmallToMid main-mini " :span="24">
              <el-form-item label="页头内容" prop="pageHeaderContent" v-if="form.htmlBatchFlag == 1 ">
                <el-input v-model="form.pageHeaderContent" type="textarea" :rows="2" ></el-input>
              </el-form-item>
            </el-col>

             <el-col class="njmindSmallToMid main-mini " :span="24">
              <el-form-item label="页尾内容" prop="pageFooterContent" v-if="form.htmlBatchFlag == 1 ">
                <el-input v-model="form.pageFooterContent" type="textarea" :rows="2" ></el-input>
              </el-form-item>
            </el-col>

            <el-col class="njmindSmallToMid main-mini " :span="24">
              <el-form-item label="表格每行内容" prop="tableRowContent" v-if="form.htmlBatchFlag == 1 ">
                <el-input v-model="form.tableRowContent" type="textarea" :rows="2" ></el-input>
              </el-form-item>
            </el-col>
            <el-col class="njmindSmallToMid main-mini " :span="24">
              <el-form-item label="表格字段定义关系"  prop="tableFieldJson" v-if="form.htmlBatchFlag == 1 ">
                <el-input v-model="form.tableFieldJson" type="textarea" :rows="2" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="第1页内容"  >
                <div name="kindeditor1" style="width:100%;height: 280px;"></div>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="第2页内容"  >
...
/*   import {
  ...
  export default {
    name: "OriginalLogMainTemplateConfig",
    props: {
       data: {
        type: Object
      },
...
//        }
      ...
      handleDel() {
        if (this.form.zshtmlId) {
          ajaxRequest("DELETE", "back/originalLogMainTempHtml/", {zshtmlId:this.form.zshtmlId}, (res) => {
             if (res.code == 200) {
          ...
          this.$message.warning( '请先选择要删除的证书配置' );
        }
      },
      remoteMethod() {
      },
      ...
      getZsHtmlDetail(){
        ...
        this.delTime();
        if(this.form.zmbId != ""){
          ajaxRequest('get', 'back/originalLogMainTempHtml/getbyzmbId',{zmbId:this.form.zmbId,jdType:this.form.jdType} , (res) => {
            if (res.code === 200) {
              if(res.daoResult){
                this.form.zshtmlId = res.daoResult.zshtmlId;
