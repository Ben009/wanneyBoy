      ...
      <el-row :gutter="20">
        ...
        <div style="margin-top:10px;">
          <el-table :max-height="QJTableMaxHeight"
            ...
            <el-table-column prop="jlbzqName" fixed label="名称" :render-header="renderHeader" show-overflow-tooltip></el-table-column>
            <!--<el-table-column prop="jlbzq_name_eng" label="计量标准器英文名称" show-overflow-tooltip></el-table-column>-->
            <el-table-column prop="jlbzqClfw" fixed label="测量范围" :render-header="renderHeader" show-overflow-tooltip></el-table-column>
            <el-table-column prop="jlbzqXhgg" fixed label="型号规格" :render-header="renderHeader" show-overflow-tooltip></el-table-column>
            <el-table-column prop="jlbzqZqddj" fixed label="准确度等级" :render-header="renderHeader" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="jlbzqZsbh" fixed label="证书编号" :render-header="renderHeader" show-overflow-tooltip></el-table-column>
            <el-table-column prop="jlbzqYxrq" fixed label="证书有效日期" :formatter="dateFormat" :render-header="renderHeader" show-overflow-tooltip></el-table-column>
...
<script>
  ...
  import paramJson from './certificateJLBZQDialog.js' // 同目录下json数据
  //引入对应的表单编辑页
...
//              headObj:{},
      ...
      methods:{
        ...
        getTableList() {
          /*获取table数据，维护data数据*/
          ajaxRequest('post','back/certificateQuality/queryJlbzq',{
            page:this.page,
            rows:this.rows,
            ...
            total:0,
            sc:this.sc,
            jlbzqName:this.searchKey==''?null:this.searchKey
          },(res)=>{
            if(res.code===200){
