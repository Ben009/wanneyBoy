...
let paramJson = [
  {sqlSeg: 'c.INSTRUMENTATION_NAME', name: '名称', nameCode: 'jlbzqName', component: 'input', comparison: inputComparsion, isSort: 0, isQueryCondition: 1, isQueryConditionDefault: 1, isQueryResult: 0, isTableDefault: 0},
  {sqlSeg: 'c.MEARSURING_RANGE', name: '测量范围', nameCode: 'jlbzqClfw', component: 'input', comparison: inputComparsion, isSort: 0, isQueryCondition: 1, isQueryConditionDefault: 1, isQueryResult: 0, isTableDefault: 0},
  {sqlSeg: 'c.MODEL', name: '型号规格', nameCode: 'jlbzqXhgg', component: 'input', comparison: inputComparsion, isSort: 0, isQueryCondition: 1, isQueryConditionDefault: 1, isQueryResult: 0, isTableDefault: 0},
  {sqlSeg: 'c.ACCURACY_CLASS', name: '准确度等级', nameCode: 'jlbzqZqddj', component: 'input', comparison: inputComparsion, isSort: 0, isQueryCondition: 1, isQueryConditionDefault: 1, isQueryResult: 0, isTableDefault: 0},
  {sqlSeg: 'aud.CERTIFICATE_NO', name: '证书编号', nameCode: 'jlbzqZsbh', component: 'input', comparison: inputComparsion, isSort: 0, isQueryCondition: 1, isQueryConditionDefault: 1, isQueryResult: 0, isTableDefault: 0},
  {sqlSeg: 'to_char(trunc(aud.EFFECTIVE_DATE),\'YYYY-MM-DD\')', name: '证书有效日期', nameCode: 'jlbzqYxrq', component: 'date', dateFormat: 'yyyy-MM-dd', comparison: dateComparison, isSort: 0, isQueryCondition: 1, isQueryConditionDefault: 1, isQueryResult: 0, isTableDefault: 0}
