      ...
      <el-row :gutter="20">
        ...
        <div style="margin-top:10px;">
          <el-table :max-height="QJTableMaxHeight"
            ...
            <el-table-column prop="jsgcName" fixed label="依据名称" :render-header="renderHeader" show-overflow-tooltip></el-table-column>
            <!--<el-table-column-->
              <!--prop="jsgcNameEng"-->
              <!--label="依据英文名称"-->
            ...
            <!--&gt;-->
              <!--min-width="236"-->
            <!--</el-table-column>-->
            <el-table-column prop="jsgcNameEng" fixed label="依据英文名称" :render-header="renderHeader" show-overflow-tooltip></el-table-column>
...
<script>
  ...
  import paramJson from './certificateJSGCDialog.js' // 同目录下json数据
...
//        },
        getTableList() {
          /*获取table数据，维护data数据*/
          ajaxRequest('post','back/certificateQuality/queryJsgc',{
            page:this.page,
            rows:this.rows,
            ...
            total:0,
            sc:this.sc,
            jsgcName:(this.searchKey==''?null:this.searchKey)
          },(res)=>{
            if(res.code===200){
