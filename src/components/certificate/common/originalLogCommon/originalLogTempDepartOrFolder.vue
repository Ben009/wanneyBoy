...
export default {
  name:"OriginalLogTempDepartOrFolder",
  props: {
    data: {
      type: Object
    },
...
//    commonFloderIsShow() {
//      let mlId = 0;
//      ajaxRequest("get", "back/originalLogTemp/" + mlId, null, res => {
//        if (res.code === 200) {
...
//    },
    handleSubmit() {
      ajaxRequest(
        "post",
        "back/originalLogTemp/addOriginalLogTempMl",
        {
          mlIdParent: 0,
    ...
    getDepartNotInML() {
      ajaxRequest("get", "back/originalLogTemp/getDepartNotInML", {}, res => {
        if (res.code === 200) {
    ...
    updateDepartMlName() {
      ajaxRequest("get", "back/originalLogTemp/updateDepMLName", {}, res => {
        if (res.code === 200) {
