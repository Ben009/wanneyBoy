<template>
  <mind-dialog
    ...
    <span slot="footer" class="dialog-footer">
      <el-button type="primary" @click="handlePrint">导 出</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handlePrint(){
        let url ="/back/bill/toExport";
        let form = $("<form></form>").attr("action", url).attr("method", "post");
        form.append($("<input></input>").attr("type", "hidden").attr("name", "billId").attr("value", this.data.id));
        form.append($("<input></input>").attr("type", "hidden").attr("name", "accountName").attr("value", this.account.accountName));
        form.append($("<input></input>").attr("type", "hidden").attr("name", "accountBank").attr("value", this.account.accountBank));
        form.append($("<input></input>").attr("type", "hidden").attr("name", "accountNo").attr("value", this.account.accountNo));
