<template>
  <div>
    <div id="ssPie" :style="{height:height,width:width,float:float}"></div>
    <div id="ysPie" :style="{height:height,width:width,float:float}"></div>
    <div id="tsPie" :style="{height:height,width:width,float:float}"></div>
  </div>
</template>
