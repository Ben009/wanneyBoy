    ...
    <mind-dialog
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        <el-table  :max-height="QJTableMaxHeight"
          ...
          <el-table-column prop="settleAccountsDate" label="到账期限" :formatter="dealDate"></el-table-column>
          ...
          <el-table-column prop="totalActual" label="费用合计"></el-table-column>
        </el-table>
...
//        this.data.total=0;
        /*获取table数据，维护data数据*/
        ajaxRequest('get','back/statistics/yewuchanzhiDetail',this.data,(res)=>{
          if(res.code===200){
