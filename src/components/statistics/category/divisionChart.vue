      ...
      initData(){
        if(this.sum=="1"){//title
          ...
          for(let i=0;i<this.list.length;i++){
            this.nameList.push(this.list[i].area);
            this.ssList.push({value:this.list[i].ss,name:this.list[i].area});//实收list
            this.ysList.push({value:this.list[i].ys,name:this.list[i].area});//应收list
            this.tsList.push({value:this.list[i].ts,name:this.list[i].area});//套数list
          }
        }
      },
      drawSsPie(){//实收
