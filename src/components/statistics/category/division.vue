    ...
    <el-form ref="form" class="sampleForm">
      <div>
        <el-Row :gutter="20">
          ...
          <el-col :span="3">
            <el-form-item label="行业" class="lbCenter"></el-form-item>
          </el-col>
          <el-col :span="3">
      ...
      <div>
        <el-table :max-height="QJTableMaxHeight"
                  ...
                  style="width: 100%"
                  :fit="true">
          <el-table-column label="行政区名称（区县）">
      ...
      <divisionChart :list="tableData" v-if="demo" :sum="sum" :height="chartHeight" :width="chartWidth"></divisionChart>
    </el-form>
  </div>
</template>
...
<script>
  ...
  import paramJson from "./divisionParam"; //同目录下json数据
  import divisionChart from "./divisionChart"; //图表
  export default {
    name:"divisionStatistics",//行政区划统计
    components: {
      divisionChart,
      WorkMould,
      TableColumnHeader,
    ...
    methods:{
      getTableList(){
        ...
        ajaxRequest('get','back/statistics/xzqhCount',{
      ...
      setOptions(){
        ...
        ajaxProxyRequest('get','/njmind/findParams/industryCategory',{codeType:'NUMBER'},(res) => {//行业option
          this.industryOptions=res.industryCategory.list;
        })
      },
