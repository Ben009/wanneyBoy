...
<template>
  <el-row style="height:100%">
    ...
    <el-col class="right  el-col el-col-24 el-col-sm-19">
      <commonQuotation ref="commonQuotation" :quotationId="quotationId"  @search="search"  :rightType="rightType"
                       style="max-height: 800px;overflow-y: scroll;">
        <template slot="footer">
                    <span slot="footer" class="dialog-footer" style="display: block;  text-align: center;">
                        <el-button type="primary" @click="setAudit" v-has="'M7101'">审核</el-button>
                    </span>
        </template>
      </commonQuotation>
    </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      setAudit() {
        this.$refs.commonQuotation.setAudit()
      }
    }
  }
</script>
