...
<template>
  <el-row style="height:100%">
    ...
    <el-col class="right  el-col el-col-24 el-col-sm-19">
      <commonQuotation ref="commonQuotation" :quotationId="quotationId"  :rightType="rightType"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 获取左侧查询数据
      getTableList() {
        ajaxSyncRequest('get', 'back/quotation/retrieveQuotationsByPlan', {
          fuzzySearch: 1,
          page: this.page,
          rows: this.rows,
          total: 0,
      ...
      //删除报价单所有已转任务
      deletePlan() {
        this.$refs.commonQuotation.deletePlan()
      }
