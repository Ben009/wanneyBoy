      ...
      <div>
        ...
        <div style="margin-top:10px;">
          <el-table :max-height="QJTableMaxHeight" v-loading="loading"
            ...
            <el-table-column prop="companyName" label="委托单位" :show-overflow-tooltip="true"
                             :render-header="QJrenderHeader"></el-table-column>
            <el-table-column prop="applianceName" label="器具名称" :show-overflow-tooltip="true"
                             :render-header="QJrenderHeader"></el-table-column>
            <el-table-column prop="applianceActualName" label="器具实际名称" :show-overflow-tooltip="true"
                             :render-header="QJrenderHeader"></el-table-column>
            <el-table-column prop="model" label="型号规格" :show-overflow-tooltip="true"
                             :render-header="QJrenderHeader"></el-table-column>
            <el-table-column prop="factoryNo" label="出厂编号" :show-overflow-tooltip="true"
                             :render-header="QJrenderHeader"></el-table-column>
            <el-table-column prop="equipmentNo" label="设备编号" :show-overflow-tooltip="true"
                             :render-header="QJrenderHeader"></el-table-column>
...
<script>
  ...
  import paramJson from "./historyPlanInspectionParam"; //同目录下json数据

  export default {
    name: "historyPlanInspection",
    ...
    methods: {
      ...
      getTableList(obj) {
        ...
        ajaxRequest(
          "get",
          "back/planAppliance/getHistoryByCompany",
          {
            page: this.page,
            rows: this.rows,
            ...
            total: 0,
            sc: obj ? obj : this.sc,
            //registrationNos: this.alreadyAddId
          },
          res => {
            if (res.code === 200) {
