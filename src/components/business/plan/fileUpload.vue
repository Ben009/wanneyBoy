  ...
  <mind-dialog
    ...
    <span slot="footer" class="dialog-footer">
      <el-button type="primary"
                 v-mindPopover="{message:'确认导入现场任务信息?',success:handleSubmit.bind(this),isOpen:handleOpen.bind(this)}">导 入</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      //下载模版
      downloadFile() {
        let url = "/back/plan/downloadFile";
      ...
      handleSubmit() {
        ...
        ajaxRequest('put', 'back/plan/uploadPlan', {filePath: filePath, fileName: fileName}, (res) => {
          if (res.code === 200) {
            _this.callback(res.rows);
          }
        });
      },
      //提交前校验
