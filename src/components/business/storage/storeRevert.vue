<template>
  <el-form ref="form" label-width="150px">
    <el-Row :gutter="20">
      <el-form-item label="入库撤销：">
        <el-radio-group v-model="revertType">
          <el-radio :label="1">样品撤销</el-radio>
          <el-radio :label="2">证书撤销</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-Row>
    <el-Row :gutter="20">
    ...
    methods:{
      search(){
        ...
        if(this.searchKey===null||this.searchKey===""||this.searchKey===undefined){
          ...
          /*获取table数据，维护data数据*/
          ajaxRequest('get','back/ruku/getRukuInfo',{
