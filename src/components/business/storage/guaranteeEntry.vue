        ...
        <el-Row :gutter="20">
            <el-col :span="12">
                <el-form-item>
                    <template slot="label">
                        <span>请输入单号：</span>
                        <el-tooltip content="登记号、流转单号、委托单号、缴费单编号、出库记录号">
...
<script>
    ...
    //担保权限弹层
    import guaranteeEntryForm from "./guaranteeEntryForm";
    ...
    export default {
        ...
        methods: {
            search() {
                ...
                /*获取table数据，维护data数据*/
                ajaxRequest('get', 'back/guarantee/getInfo', {
                    ...
                    if (res.code === 200) {
                        this.$router.push({
                            ...
                            query: {
                                ...
                                companyName: res.daoResult.bhlist[0].companyName,
                                companyType: res.daoResult.bhlist[0].companyType,
                                companyId: res.daoResult.bhlist[0].companyId,
                                djh: $.trim(this.searchKey),
                                flag: true
                            }
                        })
                    } else {
