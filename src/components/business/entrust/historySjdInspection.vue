            ...
            <div>
                ...
                <div style="margin-top:10px;">
                    <el-table :max-height="QJTableMaxHeight" v-loading="loading"
                        ...
                        <el-table-column prop="applianceActualName" label="器具实际名称"></el-table-column>
...
<script>
    ...
    import paramJson from "./js/historySjdInspectionParam"; //同目录下json数据

    export default {
        name: "historySjdInspection",
        ...
        methods: {
            ...
            getTableList(obj) {
                ...
                ajaxRequest(
                    "get",
                    "back/entrustSjd/historySjdInspection",
                    {
                        page: this.page,
                        rows: this.rows,
        ...
        mounted() {
            ...
            this.$nextTick(() => {
                ...
                this.$refs['retrieve-wapper'].search.conditions[0].sqlSeg = 'wtd.company_name';
            ...
            this.getTableList('[{"nameCode":"companyName","sqlSeg":"wtd.company_name","comparison":"1","value":' + this.companyName + '}]');
            this.QJGetMounted();
        }
    };
</script>
