<template>
    <el-col :sm="18">
        ...
        <el-row style="margin-bottom: 10px">
            <el-col :sm="26">
                <el-table :data="planApplianceData" :max-height="QJTableMaxHeight" ref="multipleTable"
                    ...
                    <el-table-column prop="estimatedWorkload" align="center" label="操作">
                        <template slot-scope="scope">
                            <el-button type="primary" v-if="scope.row.isClaim=='0'&&scope.row.registrationNo==null"
                                       class="tuhao"
                                       @click="openDialog(scope.row.id,scope.row.orderNo,scope.row.registrationNo)"
                                       style="background:none;border:none;color:#f56c6c;">退 号
                            </el-button>
                            ...
                            &nbsp;
                            <el-button type="primary" v-if="scope.row.registrationNo==null"
                                       style="margin: -7px;background:none;border:none;color:#3094e0;"
                                       @click="batchReArrange(scope.row.id,isHaveNumbers)">重新安排
                            </el-button>
                        </template>
                    </el-table-column>
        ...
        <el-row class=" m-t-10" style="margin-top: 20px">
            <el-col :span="24">
                <el-button type="warning" @click="yaohao(ids)" class="el-button--warn">批量要号</el-button>

                <el-button type="warning" class="el-button--warn" @click="runNumber()">追号</el-button>

                <el-button type="warning" @click="openDialog('',orderNo)" class="el-button--warn">退号</el-button>
            </el-col>
        </el-row>
        <el-row class=" m-t-10" style="margin-top: 30px">
            <div class="title-item"><span>追号列表</span></div>
        </el-row>
...
<style scoped>
    ...
    .custom-1d74b7 .el-button--warn {
        color: #fff;
        background-color: #3094e0;
        border-color: #3094e0;
    }

    .custom-1d74b7 .el-button--warn:hover {
        background: #4a90c5;
        color: #fff;
        border-color: #4a90c5;
    }
