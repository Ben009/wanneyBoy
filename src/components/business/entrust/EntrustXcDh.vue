 <template>
        ...
        <el-form :inline="true" >
          <el-form-item >
            <el-select v-model="searchType"  style="width:120px">
              <el-option value="0" label="委托单编号"></el-option>
  ...
  <script>
    ...
    import Demo from "./EntrustXcDHForm.vue";
    ...
    export default {
      data() {
        return {
          ...
          planData: {}, //器具信息
          orderNo:"",
          weituodanhao:"", //报价单编号 报价单附件 报价单备注\
          zhuihaoList:[],
      ...
      methods:{
        ...
        paramter["planId"]=this.planId;
          ...
          paramter["detectionMethod"]=2;
          ajaxRequest("get", "back/planAppliance/findByListQj", paramter, res => {
            if (res.code === 200) {
              this.findByListZhuihao(this.orderNo);
        ...
        getTableData(paramters) {
          ...
          ajaxRequest("GET", "back/planAppliance/findByListDh", paramters, res => {
            if (res.code === 200) {
                 ...
                 if(this.$route.params.obj !=null){
                  // this.$route.params.obj.planId,this.$route.params.obj.orderNo
                   ...
                   this.getQjInfo(this.$route.params.obj.orderNo);
                    ...
                    this.findByPlanId(this.$route.params.obj.planId);
                     this.orderNo=this.$route.params.obj.orderNo;
