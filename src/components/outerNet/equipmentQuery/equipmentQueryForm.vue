  ...
  <div>
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        <el-tabs type="border-card" v-model="tabType" @tab-click="handleClick">
          ...
          <el-tab-pane label="审核通过" name="successTab">
          </el-tab-pane>
          <el-tab-pane label="待审核" name="auditTab">
          </el-tab-pane>
          <el-tab-pane label="退回修改" name="returnTab">
          </el-tab-pane>
          <el-tab-pane label="不予备案" name="refuseTab">
          </el-tab-pane>
          ...
          <div v-show="tabType =='companyTab'" style="margin-top:10px;" >
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="s法人代表:" prop="frfb">
                  {{form.frfb}}
                </el-form-item>
              </el-col>
          ...
          <div v-show="tabType !='companyTab'" >
            ...
            <div style="display: flex;justify-content: space-between;">
              <div style="display: inline-block;text-align: center;margin:0 auto;">
                <el-button type="primary"  @click="QJAdvanceSearch" class="el-button el-icon-search el-button--primary">查询</el-button>
                <el-button type="warning" @click="QJEmptyCondition" class="el-button el-icon-warning el-button--warning" >&nbsp;清空</el-button>
              </div>
             ...
             <button data-v-52ccfdc1="" type="button" class="el-button el-icon-setting el-button--primary el-button--mini is-round"><span>个性化设置</span></button>
            ...
            <div v-show="tabType =='successTab' ||tabType =='returnTab' ||tabType =='refuseTab'" style="margin-top:10px;">
              <el-table :max-height="QJTableMaxHeight"
                :data="tableData"
                border
                style="width: 100%"
  ...
  export default {
    ...
    methods: {
      ...
      handleClick(tab, event) {
        ...
        }else if(tab.name=="auditTab"){
          this.tabType = 'auditTab';
          this.getTableList();
        }else if(tab.name=="successTab"){
          this.tabType = 'successTab';
          this.getTableList();
        }else if(tab.name=="returnTab"){
          this.tabType = 'returnTab';
          this.getTableList();
        }else if(tab.name=="refuseTab"){
          this.tabType = 'refuseTab';
          this.getTableList();
        }
      },
      getTableList(){
        ...
        var qjshstatus = '3';
        // 若查历史，则查审核状态为1的
        if("successTab" == this.tabType){
          qjshstatus = '1'
        }else if("returnTab" ==this.tabType){
          qjshstatus = '2'
        }else if("refuseTab" ==this.tabType){
          qjshstatus = '4'
        }
        ajaxRequest('get','back/equipmentQuery/queryEquipmetByShStatus',{
          fuzzySearch:1,
          page:this.page,
          rows:this.rows,
