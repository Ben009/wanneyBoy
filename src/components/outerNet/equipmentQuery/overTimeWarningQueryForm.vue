  ...
  <div>
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        <el-tabs type="border-card" v-model="tabType" @tab-click="handleClick">
          ...
          <el-tab-pane label="即将超期器具" name="overTimeWarningTab">
          </el-tab-pane>
          ...
          <div v-show="tabType !='companyTab'" >
            ...
            <div v-show="tabType =='overTimeWarningTab'" style="margin-top:10px;">
...
/*   import {
    ...
    Radio,
    RadioGroup,
    Row, Table, TableColumn, Pagination } from 'element--ui';
  Vue.use(Table);
  Vue.use(TableColumn);
  Vue.use(Form);
  Vue.use(FormItem);
  ...
  export default {
    ...
    methods: {
      ...
      handleClick(tab, event) {
        ...
        }else if(tab.name=="overTimeWarningTab"){
          this.tabType = 'overTimeWarningTab';
          this.getTableList();
        }
      },
      getTableList(){
        ...
        ajaxRequest('get','back/equipmentQuery/queryOverTimeWarningEqu',{
          fuzzySearch:1,
          page:this.page,
          rows:this.rows,
