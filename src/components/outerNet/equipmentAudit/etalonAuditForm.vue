  ...
  <div>
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        ...
        <el-tabs type="border-card" v-model="tabType" @tab-click="handleClick">
          ...
          <div v-show="tabType =='historyTab'" style="margin-bottom:10px;"	v-if="defaultOpen">
          ...
          <div v-show="tabType =='historyTab'" style="display: flex;justify-content: space-between;">
          ...
          <div v-show="tabType =='historyTab'" style="margin-top:10px;">
            <el-table :max-height="QJTableMaxHeight"
              :data="tableData"
              border
              style="width: 100%"
    ...
    <singleAuditEtalonForm v-if="!!singleAudit" :data="singleAudit" :callback="handleSingleAuditCallback"></singleAuditEtalonForm>
    <bitchSetEtalonForm v-if="!!bitchSet" :data="bitchSet" :callback="handleBitchSetCallback"></bitchSetEtalonForm>
...
<script>
  ...
  import bitchSetEtalonForm from './bitchSetEtalonForm';
  import bitchAuditForm from './bitchAuditForm';
  import singleAuditEtalonForm from './singleAuditEtalonForm';
      ...
      handleSingleAuditCallback(data){
        ...
        if (data) {
          ...
          ajaxRequest('get', 'back/equipmentAudit/singleAudit', {
            ...
            qjshStatus:data.qjshStatus,opinion:data.opinion,equipmentType:"1"
          },(res)=>{
            if(res.code===200){
      ...
      handleBitchAuditCallback(data){
        ...
        if (data) {
          ajaxRequest('get', 'back/equipmentAudit/bitchAuditData', {
            ids:data.ids,qjshStatus:data.qjshStatus,opinion:data.opinion,equipmentType:"1",
          },(res)=>{
            if(res.code===200){
