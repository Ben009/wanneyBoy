...
let paramJson = [
  {sqlSeg:'c.COMPANY_NAME',name:'单位名称',nameCode:'companyName',component:'input',comparison:'0,1',isQueryCondition:1,isSort:1},
  ...
  {sqlSeg:'c.CONTRACT_VALIDATE_BEGIN',name:'合同有效期开始时间',nameCode:'contractValidateBegin',component:'date',comparison:'1',isQueryCondition:1,isQueryResult:1,isSort:1},
  {sqlSeg:'c.CONTRACT_VALIDATE_END',name:'合同有效期结束时间',nameCode:'contractValidateEnd',component:'date',comparison:'1',isQueryCondition:1,isQueryResult:1,isSort:1},
  ...
  {sqlSeg:'c.CONTRACT_SIGN_DATE',name:'合同签署日期',nameCode:'contractSignDate',component:'date',comparison:'1',isQueryCondition:1,isQueryResult:1},
  ...
  // {sqlSeg:'c.STATUS',name:'是否审核',nameCode:'status',component:'select',comparison:'1',options:[{code:0,remark:'未审核'},{code:1,remark:'已审核'}],isQueryCondition:1,isTableDefault:1,isSort:1},
