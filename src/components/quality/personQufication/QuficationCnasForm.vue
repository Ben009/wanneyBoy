      ...
      <el-row>
        <div style="margin-top:10px;">
          <el-table :max-height="QJTableMaxHeight"
            ...
            <el-table-column prop="typeName"  label="项目类别" :render-header="renderHeader">min-width="236"</el-table-column>
            <el-table-column  prop="departName" label="所属部门" :render-header="renderHeader"> min-width="236"</el-table-column>
          </el-table>
        </div>
...
<script>
  ...
  import paramJson from './quficationCnas';
  //引入jquery
  import $ from 'jquery';
...
//        },
      ...
      getTableList() {
        /*获取table数据，维护data数据*/
        ajaxRequest('get','back/cnas/retrieve',{
          page:this.page,
          rows:this.rows,
          orderProperty:'t.id',
      ...
      checkThisQui(row){
        this.checkRow2(row,this.index2)
        this.callback()
      },
