      ...
      <el-row :gutter="20">
        ...
        <div style="margin-top:10px;">
          <el-table :max-height="QJTableMaxHeight"
            ...
            <el-table-column  prop="basisNo" label="技术依据编号" :render-header="renderHeader"></el-table-column>
            <el-table-column  prop="name"  label="技术依据名称" :render-header="renderHeader">min-width="300"</el-table-column>
            <el-table-column  prop="nameE" label="技术依据名称（英文）" :render-header="renderHeader"> min-width="236"</el-table-column>
          </el-table>
        </div>
...
<script>
  ...
  import paramJson from './quficationSpecification';
  //引入jquery
  import $ from 'jquery';
...
//        },
        getTableList() {
          /*获取table数据，维护data数据*/
          ajaxRequest('get','back/quficationProject/retrieve',{
            page:this.page,
            rows:this.rows,
