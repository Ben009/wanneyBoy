...
<template>
    <div>
        <div v-if="!detailInfo">
            ...
            <div>
                ...
                <el-table :data="tableData"
                    ...
                    <el-table-column key="userName" label="保管人" prop="userName" v-if="headObj.keeperName"  show-overflow-tooltip   :render-header="QJrenderHeader" > </el-table-column>
                    <el-table-column key="examineWay" label="核查方法" prop="examineWay" v-if="headObj.examineWay" :formatter="formatterWay" show-overflow-tooltip   :render-header="QJrenderHeader" > </el-table-column>
                    <el-table-column key="examineScheduleDate" label="核查日期" prop="examineScheduleDate" v-if="headObj.examineScheduleDate"  show-overflow-tooltip   :render-header="QJrenderHeader" > </el-table-column>
                    <el-table-column key="examineCycle" label="核查周期" prop="examineCycle" v-if="headObj.examineCycle"  show-overflow-tooltip   :render-header="QJrenderHeader" > </el-table-column>
                    <el-table-column key="nextDate" label="下次核查日期" prop="nextDate" v-if="headObj.nextDate"  show-overflow-tooltip   :render-header="QJrenderHeader" > </el-table-column>
                    <el-table-column key="certificateDate" label="核查证书日期" prop="certificateDate" v-if="headObj.certificateDate"  show-overflow-tooltip   :render-header="QJrenderHeader" > </el-table-column>
        ...
        <instrumentation-tab v-if="detailInfo" type="inspectRecordTab" :standardId="detailInfo" @goBack="back"></instrumentation-tab>
    </div>
</template>
<script>
import Vue from "vue";
...
import param from "./inspectRecordTabParam.js";
...
export default {
  ...
  methods: {
    ...
    getTableList(){
        // 加载数据
      ajaxRequest('get', 'back/instrumentationExa/retrieve', {
        page: this.page,
        rows: this.rows,
