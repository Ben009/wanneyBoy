<template>
    <div>
        ...
        <instrumentation-tab v-if="detailInfo" type="stabilityRecordTab" :standard-id="detailInfo" @goBack="back"></instrumentation-tab>
    </div>
</template>
<script>
import Vue from "vue";
...
export default {
  ...
  methods: {
    ...
    getTableList(){
      ajaxRequest('get', 'back/instrumentationStability/retrieve', {
        page: this.page,
        rows: this.rows,
