import { hasClass, addClass, removeClass } from '@/common-el/src/utils/dom';
import ElCheckbox from '@/common-el/packages/checkbox';
import ElTag from '@/common-el/packages/tag';
import Vue from 'vue';
import FilterPanel from './filter-panel.vue';
import LayoutObserver from './layout-observer';
import vuex_store from '@/store'; // vuex仓库
  ...
  methods: {
      ...
      if (this.draggingColumn && this.border) {
        ...
        const handleMouseUp = () => {
          if (this.dragging) {
            ...
            if(vuex_store.state.admin.id){
              document.getElementById(vuex_store.state.admin.id).style.cursor = '';
            }else{
              document.body.style.cursor = '';
            } 
    ...
    handleMouseMove(event, column) {
      ...
      if (!this.dragging && this.border) {
        ...
        if(vuex_store.state.admin.id){
          temp=document.getElementById(vuex_store.state.admin.id).style;
        }else{
          temp=document.body.style;
        } 
        const bodyStyle =temp;
