...
import objectAssign from '@/common-el/src/utils/merge';
import { getPropByPath } from '@/common-el/src/utils/util';
...
const forced = {
  ...
  index: {
    ...
    renderCell: function(h, { $index, column, maxRow }) {
      let i = $index + 1;
  ...
  created() {
    ...
    column.renderCell = function(h, data) {
      ...
      return _self.showOverflowTooltip || _self.showTooltipWhenOverflow
        ...
        : <div class="cell ddd">{ renderCell(h, data) }</div>;
    };
  },
